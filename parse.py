...
def parser_add_main_args(parser):
    ...
    parser.add_argument('--ood_type', type=str, default='', choices=['structure', 'label', 'feature'])
    parser.add_argument('--data_dir', type=str, default='../data/')
    parser.add_argument('--use_emo', action='store_true', help='whether to use multi-label energy')
    ...
    # model network
    parser.add_argument('--method', type=str, default='mlgood', choices=['msp', 'OE','ODIN','Mahalanobis', 'mlgood'])
